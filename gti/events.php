...
<body>
    ...
    <button class="button member" button onclick="window.location.href = 'event_create.php';"style="background-color: beige;"> Add Event </button>
    <br>
    <button class="button admin" button onclick="window.location.href = 'event_admin.php';"style="background-color: beige;"> Admin Menu </button>
    </div>
